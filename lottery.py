...
if winner:
    ...
    result = {
        ...
        "prize": prize,
        "burned": burned,
        "carry_forward": 0  # No carry-forward as winner is selected
    }
else:
    ...
    result = {
        ...
        "prize": 0,
        "burned": 0,
        "carry_forward": total_gas_fee
    }

# Save the lottery result to a file
with open('lottery_result.json', 'w') as file:
    json.dump(result, file, indent=4)

print("Lottery result saved to lottery_result.json")
